...
@section('title')افزودن اسلایدر@stop
@section('current-page-title')افزودن اسلایدر@stop
@section('breadcrumbs')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-subtitle">در اینجا می توانید اسلایدر جدید اضافه کنید.</p>
                    <form class="clearfix" action="{{route('admin.slider.store')}}"
                          method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
