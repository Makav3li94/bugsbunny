...
@section('title')لیست سوالات متداول@stop
@section('current-page-title')لیست سوالات متداول@stop
@section('breadcrumbs')
    <li class="breadcrumb-item">سوالات متداول ها</li>
    <li class="breadcrumb-item active">لیست سوالات متداول ها</li>
@stop
@section('content')
    <!-- List Customer -->
        ...
        <div class="col-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-subtitle">در اینجا عنوان سوالات متداول خود را مشاهده کنید.</p>
                    <form class="form-horizontal clearfix" id=""
                          action="{{route('admin.front_faq.update',$faqs[0]->id)}}"
                          method="post">
                        @csrf
                        @method('PATCH')
                        <div class="row form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" value="{{$faqs[0]->title}}" placeholder="عنوان"
                                       name="title">
                                @if($errors->has('title'))
                                    {{$errors->first('title')}}
                                @endif
                        ...
                        <div class="row form-group">
                            <label class="col-sm-3 text-right control-label col-form-label">زیرنویس : <span
                                    class="text-danger mr-1">*</span></label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" value="{{$faqs[0]->sub}}" placeholder="زیرنویس"
                                       name="sub">
                                @if($errors->has('sub'))
                                    {{$errors->first('sub')}}
                                @endif
        ...
        <div class="col-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-subtitle">در اینجا لیست سوالات متداول خود را مشاهده کنید.</p>
                                ...
                                @if($key!=0)
                                    <tr>
                                        ...
                                        <td style="width: 120px;">
                                            <button class="btn btn-success btn-sm edit-faq" id="{{$item->id}}"><i
                                            ...
                                            <form method="post"
                                                  action="{{route('admin.front_faq.delete',$item->id)}}"
                                                  id="{{$item->id}}">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                ...
                <div class="card-body">
                    <div class="form-group text-center mt-3">
                        <button type="button" class="btn btn-success btn-rounded waves-effect waves-light"
                                data-toggle="collapse" href="#collapseCat">افزودن سوالات متداول جدید
                        </button>
                    </div>
                    <form class="form-horizontal clearfix" id="collapseCat"
                          action="{{route('admin.front_faq.store')}}"
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control" placeholder="پاسخ" name="answer">
    ...
    <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
         aria-hidden="true" style="display: none;" id="collapseFaqEdit">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-body">
                    <form class="form-horizontal clearfix" id="collapseFaqForm" action=""
                          enctype="multipart/form-data" method="post">
                        @csrf
                        @method('PATCH')
                        <div class="row form-group">
                            <label class="col-sm-3 text-right control-label col-form-label">سوال : <span
                                    class="text-danger mr-1">*</span></label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" placeholder="عنوان" name="question">
                                @if($errors->has('question'))
                                    {{$errors->first('question')}}
                                @endif
                            </div>
                        ...
                        <div class="row form-group">
                            <label class="col-sm-3 text-right control-label col-form-label">پاسخ : <span
                                    class="text-danger mr-1">*</span></label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" placeholder="زیرنویس" name="answer">
                                @if($errors->has('answer'))
                                    {{$errors->first('answer')}}
                                @endif
                            </div>
