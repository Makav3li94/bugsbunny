        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-subtitle">سوالات و و مشکلات خود را با کارشناسان ما در میان بگذارید</p>
                    <form class="form-horizontal clearfix" method="post" action="{{route('user.ticket.store')}}" enctype="multipart/form-data">
                        @csrf
