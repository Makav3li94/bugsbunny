                    ...
                    <div class="forum-post-content">
                        <div class="content">
                            ...
                            <form action="{{route('quiz',$section)}}" method="post" class="">
                                ...
                                @if($section->kind == 0)
                                    @if($section->status == 4)
                                        <div class="alert alert-info text-center">چالش به پایان رسیده است.
                                        </div>
                                    @else
                            ...
                            @if($best_user != '' || $best_user != null)
                                <div class="best-answer">
                                    <div class="row">
                                        <div class="col-lg-9">
                                            <div class="forum-post-top">
                                                ...
                                                <div class="forum-post-author">
                                                    <a class="author-name" href="{{route('user',$best_user->user->username)}}">{{$best_user->user->username}} </a>
                                                    <div class="forum-author-meta">
                                                        <div class="author-badge">
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                 xmlns:xlink="http://www.w3.org/1999/xlink" width="16px"
                                    ...
                                    <div class="best-ans-content d-flex">
                                        ...
                                        <p>
                                            برنده این چالش {{$best_user->user->name}} است با کسب {{$best_user->score}}
                                            امتیاز !
                                        </p>
                                    </div>
                                </div>
                        ...
                        @forelse($replies as $reply)
                            <div class="forum-comment">
                                <div class="forum-post-top">
                                    ...
                                    <div class="forum-post-author">
                                        <a class="author-name" href="{{route('user',$reply->user->username)}}">{{$reply->user->username}}</a>
                                        <div class="forum-author-meta">
                                            <div class="author-badge">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                     xmlns:xlink="http://www.w3.org/1999/xlink" width="16px"
                            ...
                            @forelse($reply->children as $replyChild)
                                <div class="best-answer ">
                                    <div class="row">
                                        <div class="col-lg-9">
                                            <div class="forum-post-top">
                                                <a class="author-avatar" href="{{route('user',$replyChild->user->username)}}">
