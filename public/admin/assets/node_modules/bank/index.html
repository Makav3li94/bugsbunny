...
<input type="text"  id="cardnumber" onchange="sunnyweb_check_number();">
<p id="card_er" style="display: none; color: red;margin: 2% 0 0 0;background: #ffff0029;padding-right: 5%;">شماره کارت اشتباه می باشد</p>
