    ...
    w.FE.LinkRegExCommon = "[a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_.]{1,}", w.FE.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;/~+#-\\'*-_{}]*)|())", w.FE.LinkRegExTLD = "((" + w.FE.LinkRegExCommon + ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))", w.FE.LinkRegExHTTP = "((ftp|http|https):\\/\\/" + w.FE.LinkRegExCommon + ")", w.FE.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@" + w.FE.LinkRegExCommon + ")", w.FE.LinkRegExWWW = "(www\\." + w.FE.LinkRegExCommon + "\\.[a-z0-9-]{2,24})", w.FE.LinkRegEx = "(" + w.FE.LinkRegExTLD + "|" + w.FE.LinkRegExHTTP + "|" + w.FE.LinkRegExWWW + "|" + w.FE.LinkRegExAuth + ")" + w.FE.LinkRegExEnd, w.FE.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"], w.FE.MAIL_REGEX = /.+@.+\..+/i, w.FE.MODULES.helpers = function (i) {
        ...
        function l() {
            ...
            try {
                ...
                if (d.core.isEmpty()) return d.selection.setAtStart(d.el), d.$el.find(".fr-marker:first").replaceWith('<span class="fr-single-marker" style="display: none; line-height: 0;">' + w.FE.INVISIBLE_SPACE + "</span>"), d.$el.find(".fr-marker").remove(), d.$el.find(".fr-single-marker").removeClass("fr-single-marker").addClass("fr-marker").get(0);
        ...
        function c(e) {
            ...
            if (n = n.previousSibling, !u.node.isBlock(n) && u.node.isEditable(n)) {
                ...
                if (n.nodeType == Node.TEXT_NODE) {
                    ...
                    if (0 === n.textContent.length) if (i && u.opts.keepFormatOnDelete) w(n).after(w.FE.INVISIBLE_SPACE + w.FE.MARKERS); else if ((2 != n.parentNode.childNodes.length || n.parentNode != e.parentNode) && 1 != n.parentNode.childNodes.length || u.node.isBlock(n.parentNode) || u.node.isElement(n.parentNode) || !u.node.isDeletable(n.parentNode)) {
        ...
        function m(e, t, n) {
            ...
            if (null == r) u.html.defaultTag() && e.parentNode === u.el ? w(e).replaceWith("<" + u.html.defaultTag() + ">" + w.FE.MARKERS + "<br></" + u.html.defaultTag() + ">") : (e.nextSibling && !u.node.isBlock(e.nextSibling) || w(e).after("<br>"), w(e).replaceWith("<br>" + w.FE.MARKERS)); else {
                var o = e, i = "";
        ...
        function m(e, t, n) {
            if (e) {
                ...
                if (e) {
                    ...
                    if (o) (w(o).find(".fr-marker").length || "UL" == o.tagName || "OL" == o.tagName) && m(o.firstChild, t, n); else {
            ...
            _init: function () {
                ...
                for (var n, r, o, i = !(p.ul = !0), a = 0, s = 0; s < e.length; s++) {
                    ...
                    if (d === v(h(v("mcVRDoB1BGILD7YFe1BTXBA7B6=="))) || 0 <= d.indexOf(g, d.length - g.length) || y(g)) {
                        if (!((null === (n = l[1]) || new Date(n) < new Date(v("2B3B9A6C7C2C4C3H3I3B2=="))) && 0 < (g || "").length) || y(g)) {
                            p.ul = !1;
                            break
                        }
        ...
        function t(e) {
            ...
            if (y.$win.scrollTop(), e && e.clipboardData && e.clipboardData.getData) {
                ...
                if (y.helpers.isArray(n)) for (var r = 0; r < n.length; r++) t += n[r] + ";"; else t = n;
                if (N = "", /text\/rtf/.test(t) && (a = e.clipboardData.getData("text/rtf")), /text\/html/.test(t) && !y.browser.safari ? N = e.clipboardData.getData("text/html") : /text\/rtf/.test(t) && y.browser.safari ? N = a : /public.rtf/.test(t) && y.browser.safari && (N = e.clipboardData.getData("text/rtf")), "" !== N) return s(), e.preventDefault && (e.stopPropagation(), e.preventDefault()), !1;
                N = null
            }
            return function () {
                ...
                y.helpers.isIOS() && y.$sc && y.$sc.overflow("hidden");
                o.focus(), y.helpers.isIOS() && y.$sc && y.$sc.overflow("hidden", "");
        ...
        function r(e) {
            if (e.originalEvent && (e = e.originalEvent), e && e.dataTransfer && e.dataTransfer.getData) {
                ...
                if (N = "", /text\/rtf/.test(t) && (a = e.dataTransfer.getData("text/rtf")), /text\/html/.test(t) ? N = e.dataTransfer.getData("text/html") : /text\/rtf/.test(t) && y.browser.safari ? N = a : /text\/plain/.test(t) && !this.browser.mozilla && (N = y.html.escapeEntities(e.dataTransfer.getData("text/plain")).replace(/\n/g, "<br>")), "" !== N) {
                    y.keys.forceUndo(), C = y.snapshot.get(), y.selection.save(), y.$el.find(".fr-marker").removeClass("fr-marker").addClass("fr-marker-helper");
        ...
        function s() {
            y.browser.edge && y.opts.iframe && y.$box.after(o), C || (y.keys.forceUndo(), C = y.snapshot.get()), N || (N = o.get(0).innerHTML, y.selection.restore(), y.events.enableBlur());
        ...
        function l(r, e, t) {
            ...
            if (!e && (c = function (e) {
                ...
                y.opts.htmlAllowedStyleProps = y.opts.pasteAllowedStyleProps, y.opts.htmlAllowComments = !1, r = (r = (r = r.replace(/<span class="Apple-tab-span">\s*<\/span>/g, A(y.opts.tabSpaces || 4))).replace(/<span class="Apple-tab-span" style="white-space:pre">(\t*)<\/span>/g, function (e, t) {
                    return A(t.length * (y.opts.tabSpaces || 4))
                })).replace(/\t/g, A(y.opts.tabSpaces || 4)), r = y.clean.html(r, y.opts.pasteDeniedTags, y.opts.pasteDeniedAttrs), y.opts.htmlAllowedStyleProps = p, y.opts.htmlAllowComments = !0, r = (r = (r = x(r)).replace(/\r/g, "")).replace(/^ */g, "").replace(/ *$/g, "")
            }
            ...
            }(r))), y.opts.pastePlain && !c && (r = function (e) {
                var t, n = null, r = y.doc.createElement("div");
                r.innerHTML = e;
            ...
            if ("string" == typeof u && (r = u), "" !== r) {
                ...
                if (y.opts.enter == w.FE.ENTER_BR) for (n = (o = g.querySelectorAll("p, div")).length - 1; 0 <= n; n--) 0 === (i = o[n]).attributes.length && (i.outerHTML = i.innerHTML + (i.nextSibling && !y.node.isEmpty(i) ? "<br>" : "")); else if (y.opts.enter == w.FE.ENTER_DIV) for (n = (o = g.getElementsByTagName("p")).length - 1; 0 <= n; n--) 0 === (i = o[n]).attributes.length && (i.outerHTML = "<div>" + i.innerHTML + "</div>"); else y.opts.enter == w.FE.ENTER_P && 1 == g.childNodes.length && "P" == g.childNodes[0].tagName && 0 === g.childNodes[0].attributes.length && (g.childNodes[0].outerHTML = g.childNodes[0].innerHTML);
            ...
            y.events.trigger("paste.after"), y.undo.saveStep(C), C = null, y.undo.saveStep()
        }
        ...
        function x(e) {
            ...
            for (var r = d(Array.prototype.slice.call(n.querySelectorAll(":scope > div:not([style]), td > div:not([style]), th > div:not([style]), li > div:not([style])"))); r.length;) {
                var o = r[r.length - 1];
                if (y.html.defaultTag() && "div" != y.html.defaultTag()) o.querySelector(y.html.blockTagsQuery()) ? o.outerHTML = o.innerHTML : o.outerHTML = "<" + y.html.defaultTag() + ">" + o.innerHTML + "</" + y.html.defaultTag() + ">"; else {
        ...
        return {
            _init: function () {
                y.el.addEventListener("copy", e), y.el.addEventListener("cut", e), y.el.addEventListener("paste", t, {capture: !0}), y.events.on("drop", r), y.browser.msie && y.browser.version < 11 && (y.events.on("mouseup", function (e) {
        ...
        return {
            _init: function () {
                ...
                if (!r) for (var t in r = {}, w.FE.SHORTCUTS_MAP) w.FE.SHORTCUTS_MAP.hasOwnProperty(t) && 0 <= s.opts.shortcutsEnabled.indexOf(w.FE.SHORTCUTS_MAP[t].cmd) && (r[w.FE.SHORTCUTS_MAP[t].cmd + "." + (w.FE.SHORTCUTS_MAP[t].val || "")] = {
